...
namespace Seven.Mathematics.Symbolics
{
    /// <summary>
    ...
    public class SampleGenerator
    {
        ...
        protected BinaryOp GetRandomOperation(INode child1, INode child2)
        {
            ...
            {
                case 0:
                    return new Arithmetic_Operators.Plus<double>(child1, child2);
                case 1:
                    return new Arithmetic_Operators.Minus<double>(child1, child2);
                case 2:
                    return new Arithmetic_Operators.Product<double>(child1, child2);
                case 3:
                    return new Arithmetic_Operators.Divide<double>(child1, child2);
                case 4:
                    return new Arithmetic_Operators.Pow<double>(child1, child2);
            }
            return new Arithmetic_Operators.Plus<double>(child1, child2);
        }
