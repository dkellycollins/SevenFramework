...
namespace Seven.Structures
{
  ...
  [Serializable]
  public class HashTableLinked<Value, Key> : HashTable<Value, Key>
  {
    ...
    private class HashTableLinkedNode
    {
      ...
      internal HashTableLinkedNode(Key key, Value value, HashTableLinkedNode next)
      {
        _key = key;
        _value = value;
        _next = next;
    ...
    private HashTableLinkedNode Find(Key key, int loc)
    {
