...
namespace Seven.Structures
{
  ...
  public class AvlTreeLinked<Type> : AvlTree<Type>
  {
    ...
    public Node UnsafeTop { get { return _avlTree; } set { _avlTree = value; } }
    ...
    /// <remarks>Runtime: O(1).</remarks>
    public AvlTreeLinked(Compare<Type> compare)
    {
      _avlTree = null;
      _count = 0;
      _compare = compare;
    ...
    {
      return AvlTreeLinked<Type>.GetEnumerator(this._avlTree);
    }
    private static IEnumerator<Type> GetEnumerator(Node avltreeNode)
    {
      if (avltreeNode != null)
      {
        AvlTreeLinked<Type>.GetEnumerator(avltreeNode.LeftChild);
        yield return avltreeNode.Value;
        AvlTreeLinked<Type>.GetEnumerator(avltreeNode.RightChild);
      }
    }
    ...
    {
      AvlTreeLinked<Type>.TraversalInOrder(function, _avlTree);
    }
    protected static bool TraversalInOrder(Foreach<Type> function, Node avltreeNode)
    {
      if (avltreeNode != null)
      {
        AvlTreeLinked<Type>.TraversalInOrder(function, avltreeNode.LeftChild);
        function(avltreeNode.Value);
        AvlTreeLinked<Type>.TraversalInOrder(function, avltreeNode.RightChild);
      }
      return true;
    }
    ...
    {
      return AvlTreeLinked<Type>.TraversalInOrder(function, _avlTree);
    }
    protected static ForeachStatus TraversalInOrder(ForeachBreak<Type> function, Node avltreeNode)
    {
      if (avltreeNode != null)
      {
        if (AvlTreeLinked<Type>.TraversalInOrder(function, avltreeNode.LeftChild) == ForeachStatus.Break)
        ...
        if (status == ForeachStatus.Break)
          return ForeachStatus.Break;
        if (AvlTreeLinked<Type>.TraversalInOrder(function, avltreeNode.RightChild) == ForeachStatus.Break)
          return ForeachStatus.Break;
      }
    ...
    {
      AvlTreeLinked<Type>.TraversalPreOrder(function, _avlTree);
    }
    protected static bool TraversalPreOrder(Foreach<Type> function, Node avltreeNode)
    {
      ...
      {
        function(avltreeNode.Value);
        AvlTreeLinked<Type>.TraversalPreOrder(function, avltreeNode.LeftChild);
        AvlTreeLinked<Type>.TraversalPreOrder(function, avltreeNode.RightChild);
      }
      return true;
    }
    ...
    {
      return AvlTreeLinked<Type>.TraversalPreOrder(function, _avlTree);
    }
    protected static ForeachStatus TraversalPreOrder(ForeachBreak<Type> function, Node avltreeNode)
    {
      if (avltreeNode != null)
      {
        ...
        if (status == ForeachStatus.Break)
          return ForeachStatus.Break;
        if (AvlTreeLinked<Type>.TraversalPreOrder(function, avltreeNode.LeftChild) == ForeachStatus.Break)
          return ForeachStatus.Break;
        if (AvlTreeLinked<Type>.TraversalPreOrder(function, avltreeNode.RightChild) == ForeachStatus.Break)
          return ForeachStatus.Break;
      }
      return ForeachStatus.Continue;
    }
    ...
    {
      AvlTreeLinked<Type>.TraversalPostOrder(function, _avlTree);
    }
    protected static bool TraversalPostOrder(Foreach<Type> function, Node avltreeNode)
    {
      if (avltreeNode != null)
      {
        AvlTreeLinked<Type>.TraversalPostOrder(function, avltreeNode.RightChild);
        function(avltreeNode.Value);
        AvlTreeLinked<Type>.TraversalPostOrder(function, avltreeNode.LeftChild);
      }
      return true;
    }
    ...
    {
      return AvlTreeLinked<Type>.TraversalPostOrder(function, _avlTree);
    }
    protected static ForeachStatus TraversalPostOrder(ForeachBreak<Type> function, Node avltreeNode)
    {
      if (avltreeNode != null)
      {
        if (AvlTreeLinked<Type>.TraversalPostOrder(function, avltreeNode.RightChild) == ForeachStatus.Break)
          return ForeachStatus.Break;
        Type value = avltreeNode.Value;
        ForeachStatus status = function(value);
        avltreeNode.Value = value;
        if (status == ForeachStatus.Break)
          return ForeachStatus.Break;
        if (AvlTreeLinked<Type>.TraversalPostOrder(function, avltreeNode.LeftChild) == ForeachStatus.Break)
          return ForeachStatus.Break;
      }
      return ForeachStatus.Continue;
    }
  ...
  /// <remarks>The runtimes of each public member are included in the "remarks" xml tags.</remarks>
  [Serializable]
  public class AvlTreeLinkedThreadSafe<Type> : AvlTreeLinked<Type>
  {
